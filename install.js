...
var downloadUrl = 'http://selenium-release.storage.googleapis.com/%s/IEDriverServer_Win32_%s.0.zip'
...
var fileName = util.format('IEDriverServer_Win32_%s.0.zip', helper.version);
